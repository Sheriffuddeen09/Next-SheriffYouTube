...
export default function NotPostList(post:Posts){
    ...
    return(
      <div>
        ...
        <div className='flex lg:flex-col flex-row gap-5 my-1.5 text-sm sm:translate-x-0 -translate-x-2'>
        <Link href={``}>
             ...
             />
              <div className='bg-rel bg-rel relative bottom-60  transition-all duration-500 ease-in-out  -translate-y-2 -mb-60 h-60 rounded-xl'>
              <div className='flex flex-row relative translate-y-2 top-24 left-40 p-1 gap-1'>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6  border border-white  rounded-full text-blue-600">
  <path stroke-linecap="round" stroke-linejoin="round" d="m9 12.75 3 3m0 0 3-3m-3 3v-7.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
         ...
         <span className=' block sm:hidden'>
             <Video src={post.video} width={150} className=' mb-2 w-20 h-28 rounded-xl p-1'
             />
              <div className='w-40 bg-rel relative bottom-32 -translate-y-2 -mb-60 h-32 rounded-xl transition-all duration-500 ease-in-out'>
              <div className='flex flex-row relative top-12 left-16 p-1 gap-1'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6  border border-white  rounded-full text-blue-600">
  <path stroke-linecap="round" stroke-linejoin="round" d="m9 12.75 3 3m0 0 3-3m-3 3v-7.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
</svg>
         ...
         <div className='-translate-x-14 sm:translate-x-0'>
        ...
        <p className='text-sm sm:hidden block w-24' style={{fontSize:"10px"}}>
            { 
                (post.title).length <= 10 ?
                post.title : `${(post.title).slice(0,38)}...`
        ...
        <p className='text-sm text-gray-400' style={{fontSize:"9px"}}>{post.tag}</p>
        <p className='text-sm text-gray-400' style={{fontSize:"9px"}}>{post.views} * {post.date}</p>
        </Link>
        </div>
