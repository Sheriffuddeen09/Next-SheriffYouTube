    ...
    return(
      <div>
        ...
        <div className='inline-flex'>
          <Link href={`/downloadid/${post.id}`} className='inline-flex gap-2'>
        ...
        <Link href={`/downloadid/${post.id}`} className='hidden sm:block'>
        <p className='text-sm text-gray-400'>{post.tag}</p>
        <p className='text-sm text-gray-400'>{post.views} * {post.date}</p>
        </Link>
        <Link href={`/downloadid/${post.id}`} className='block sm:hidden'>
