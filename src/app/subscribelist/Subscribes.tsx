...
import SubscribeLists from "./SubscribeList"
import Short from "./ShortLists"
...
export default async function Subscribes (){
    ...
    return (
        ...
        <div className="inline-flex gap-4 items-center -translate-x-16">
...
Short</p>
<Link href={'/view'} className="text-blue-400">view all</Link>
</div>
                <Short />
            </div>
        </section>
