      ...
      <div>
        ...
        <p className='text-sm text-gray-400'>{post.views} * {post.date}</p>
          ...
          <div className='hidden sm:block'>
            <div onClick={handleIcon} className={` flex flex-col w-60  sm:w-64 rounded-xl p-4 relative -mb-96 -top-64 sm:-top-80 bg-filter -translate-y-10 sm:left-32 left-16  z-10 ${icon ? "block" : "hidden"}`}>
...
Report</p>
        ...
        <div onClick={handleIcon} className={` w-full h-full p-1 toggle-bg fixed bg-black items-center top-0 left-0 z-10  ${icon ? "block" : "hidden"}`}>
          <div className='bg-white text-black w-80 z-10 p-4 rounded-xl flex flex-col translate-y-32'>
            <p className='inline-flex text-black font-bold gap-4 my-1.5 text-sm items-center'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="border size-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.347a1.125 1.125 0 0 1 0 1.972l-11.54 6.347a1.125 1.125 0 0 1-1.667-.986V5.653Z" />
</svg>
Add to queue</p>
            <p className='inline-flex text-black font-bold gap-4 my-1.5 text-sm items-center'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
</svg>
Save to Watch Later</p>
            <p className='inline-flex text-black font-bold gap-4 my-1.5 text-sm items-center'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6">
