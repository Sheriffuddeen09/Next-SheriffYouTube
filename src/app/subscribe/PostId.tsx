...
return(
    <div className={mutating ? "" : ""}>
      ...
      <div className='flex flex-col mt-20 px-3 sm:px-8 lg:flex-col sm:my-1.5 text-sm'>
       ...
       <span className='w-80'>
           <Video src={post.video} width={310} className='bg-gray-50 w-52 mb-2 h-72 rounded-xl sm:hidden block'
           />
       </span>
       <div>
...
Report</p>  
          ...
          <section className={`bg-filter flex flex-col p-3 text-sm font-bold mt-16 ml-3 rounded-2xl w-80 sm:w-11/12`}>
