...
export default function TodoIdList (post:Posts){
    ...
    return(
        ...
        <div className='sm:inline-flex gap-16 my-1.5 text-sm md:mt-16 md:gap-24 ml-8'>
        <Link href={`/subscribeid/${post.id}`}>
             <span className=''>
             ...
             />
             <div className='w-52 bg-relative relative bottom-32 -translate-y-2 -mb-60 h-32 rounded-xl transition-all duration-500 ease-in-out'>
        ...
        <div className='inline-flex gap-14'>
          <Link href={`/subscribeid/${post.id}`} className='inline-flex gap-2'>
         <p className='text-sm'>
            { 
        ...
        <Link href={`/subscribeid/${post.id}`}>
        <p className='text-sm text-gray-400' style={{fontSize:"11px"}}>{post.tag}</p>
        <p className='text-sm text-gray-400' style={{fontSize:"11px"}}>{post.views} * {post.date}</p>
        </Link>
        </div>
