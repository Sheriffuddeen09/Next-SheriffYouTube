...
export default async function Subscribe (){
    ...
    return (
        ...
        <div className="inline-flex gap-2 sm:gap-4 items-center -translate-x-20 sm:translate-x-0">
...
Short</p>
<Link href={'/view'} className="text-blue-400 -translate-x-20 sm:translate-x-0">view all</Link>
</div>
                <Short />
            </div>
        </section>
