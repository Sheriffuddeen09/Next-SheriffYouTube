...
export default function ShortItems(post:Posts){
...
return(
  ...
  <div className='translate-x-3'>
    ...
    <Link href={'/subscribeshort'} className='hidden sm:block'>
    {post.title} </Link>
    <Link href={'/subscribeshort'} className='block sm:hidden w-52'>
    {post.title} </Link><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-6 cursor-pointers" onClick={handleIcon}>
