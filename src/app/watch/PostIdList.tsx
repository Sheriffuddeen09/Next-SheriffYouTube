...
import PostIdSecond from "./PostIdSecond"
...
export default async function PostIdList (){
    ...
    return (
        <section className="-translate-x-6 sm:translate-x-0">
             <div className="sm:mt-20 sm:mb-16 sm:translate-y-10">
                {button}
            </div>
            <div className="sm:translate-y-24 mt-4">
            {content}
              
            </div>
          
            <div className="sm:hidden w-60 block ml-3 p-2 flex translate-y-20 gap-2 rounded-lg scrollb scroll-p-0 scroll-smooth scrollbar scrollbar-thumb-blue-300  scrollbar-thin scrollbar-track-white ">
            ...
            <div className="translate-y-14 ml-4 sm:hidden block">
            <PostIddown />
            </div>
        </section>
    )
