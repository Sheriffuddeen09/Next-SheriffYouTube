...
export default async function PostIdList (){
    ...
    const button = (
        ...
        <main className="fixed py-2 flex flex-row z-10 w-72 mb-6 gap-3 ml-5 sm:ml-10 lg:w-96 md:w-8/12 rounded-lg mb-12 scrollba scroll-p-0 scroll-smooth scrollbar scrollbar-thumb-transparent  scrollbar-thin scrollbar-track-transparent">
    ...
    return (
        <section className="sm:translate-x-0 -translate-x-3">
           <div className="-mt-10 sm:mt-28 sm:mb-10 translate-x-2">
                {button}
            </div>
            <div className="sm:mt-16 mt-8 sm:translate-y-10">
            {content}
              
            </div>
            
            <div className="sm:hidden block ml-6 w-72 p-2 flex flex-row  translate-y-20 gap-2 rounded-lg scrollb scroll-p-0 scroll-smooth scrollbar scrollbar-thumb-transparent  scrollbar-thin scrollbar-transparent ">
