...
export default function PostYou(post:Posts){
    ...
    return(
      <div>
        ...
        <Link href={`/editlikeds/${post.id}`}>
             <div className='width hidden translate-x-3 sm:block'>
             <Video src={post.video} width={230} className=' mb-2 w-40 md:w-32 h-40 rounded-xl p-1'/>
            <div className='w-60 bg-relative relative bottom-40 -translate-y-2 -mb-40 h-40 rounded-xl transition-all duration-500 ease-in-out'>
            ...
            <span className=' block sm:hidden -translate-x-2' style={{width:'300px'}}>
        ...
        <div className='inline-flex gap-0 '>
          <Link href={`/editlikeds/${post.id}`} className='inline-flex gap-2'>
